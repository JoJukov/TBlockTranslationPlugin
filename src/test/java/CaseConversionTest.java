...
public class CaseConversionTest {
    ...
    public void setUp() {
        ...
        messageConverter.setConvertFromCamelCaseToNormalCase(true);
        messageConverter.setConvertFromKebabCaseToNormalCase(true);
        messageConverter.setConvertFromSnakeCaseToNormalCase(true);
    }
